...
export const BusinessConfigView: React.FC<BusinessConfigViewProps> = ({
  ...
  return (
    <div className="space-y-6 pb-12 animate-in fade-in duration-300">
      ...
      <div className="flex border-b border-slate-200 overflow-x-auto gap-1 -mx-2 px-2 sm:mx-0 sm:px-0 scrollbar-none touch-scroll pb-0.5">
        {[
        ...
        {activeTab === 'inventory' && (
          <div className="bg-white p-5 sm:p-6 rounded-xl border border-slate-200/90 shadow-xs space-y-5 animate-in fade-in">
            ...
            <div className="p-4 rounded-xl border border-rose-200 bg-rose-50/50 flex items-start gap-3">
              ...
              <div>
                <h4 className="text-xs font-bold text-slate-900">Automated Background Surveillance</h4>
                <p className="text-xs text-slate-600 mt-0.5">
                  The system continuously monitors all warehouse and asset inventories in the background. If any item's <code className="text-rose-700 font-bold bg-white px-1 py-0.5 rounded border border-rose-200">currentQty</code> falls below your defined threshold, a high-priority, persistent notification banner is surfaced on screen.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3.5 py-2 bg-white border border-slate-300 rounded-lg text-sm font-bold text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-colors"
                  />
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2 bg-white border border-slate-300 rounded-lg text-sm font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-colors"
                >
